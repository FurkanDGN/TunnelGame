...
public interface ServerInfos {
  ...
  static Runnable init(
    ...
    @NotNull final Supplier<Set<com.github.furkandgn.tunnelgame.common.game.Session>> sessionSupplier
  ) {
   ...
   */
  private static Set<Session> buildSessions(Set<com.github.furkandgn.tunnelgame.common.game.Session> sessionSupplier) {
